[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-7f7980b617ed060a017424585567c406b6ee15c891e84e1186181d67ecf80aa0.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=13013762)
...
adapt your `eval` implementation to become the _first 10_ cases
of `evalE`.
...
[Repl.hs](/src/Language/Nano/Repl.hs) that we suggest you understand (and
complete the implementation of where necessary.)

 We've also provided the hex representation of the "λ" character as the String
`lambda` in Main.hs. If you are running into issues with the "λ", please make
sure you have not modified the line `setLocaleEncoding utf8` from the starter
code - this must be the first line that runs in `main`. If you are still having
